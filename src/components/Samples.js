...
const Samples = () => {
  ...
  const fetchTestRequests = async (page = 1) => {
    try {
      ...
      const response = await axios.get(getApiUrl(`/test-requests?page=${page}&per_page=${recordsPerPage}`));
    ...
    return (
      <div className="container-fluid">
        <Alert variant="danger">
          ...
          <p><strong>Solution:</strong> Make sure the backend server is running and accessible</p>
