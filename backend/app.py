...
# Enable CORS for React frontend (supports both local and production)
allowed_origins = [
    'http://localhost:3000',
    'http://localhost:3001',
...
# Priority: 1. DATABASE_URL env var, 2. Fallback to Neon database
...
def get_samples():
    """Alias endpoint for /api/test-requests - used by frontend Samples page"""
    return get_test_requests()
